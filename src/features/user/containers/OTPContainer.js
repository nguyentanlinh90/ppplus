                ...
                <View
                  ...
                  {this.state.resendOtp ? (
                    <View
                      ...
                      <Text style={styleUser.txtOTP}>sau {''}</Text>
                      <Text style={styleUser.txtOTP}>0s</Text>
                    </View>
                  ) : (
                    <View
                      style={{
                      ...
                      <Text style={styleUser.txtOTP}>Gửi lại mã sau {''}</Text>
                      <Text style={[styleUser.txtOTP, {color: '#0097F2'}]}>
                        {this.state.timer}s
                      </Text>
                    </View>
                  ...
                  {this.state.isActive ? (
                    <TouchableOpacity
                      ...
                      <LinearGradient
                        colors={['#0045A5', '#0085E1', '#0097F2']}
                        useAngle={true}
                        angle={-90}
                        style={styleUser.buttonContainer}>
