...
import {View, SafeAreaView, KeyboardAvoidingView, StatusBar, Image} from 'react-native';
...
export class CreateAccountContainer extends Component {
    ...
    handleLogin =()=>{
        ...
        if(phone != "" || password != ""){
            ...
            this.dropdown.alertWithType('error', 'Lỗi', 'Vui lòng nhập đầy đủ số điện thoại và mật khẩu');
        }
    }
    ...
    componentWillReceiveProps(nextProps) {
        if(nextProps.msg_code == 'login_error'){
            ...
            this.dropdown.alertWithType('error', 'Lỗi', 'Số điện thoại hoặc mặt khẩu không đúng');
            ...
            <View style={[styles.body,{backgroundColor:'#ffffff'}]}>
                <SafeAreaView style={{backgroundColor:'#ffffff', flex:1}}>
                    ...
                    <View style={{height:'100%'}}>
                        ...
                        <View style={styleUser.footerLogin}>
                            <Image resizeMode={'stretch'} style={{width:'100%', height:160}} source={require('../../../assets/images/footer_login.png')} />
                        </View>
                    </View>
                    <Spinner
