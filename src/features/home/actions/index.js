...
export const getJobs = () => async dispatch => {
  const path = 'jobs';
  const params = '';
  const {json} = await callGetApi(path, params);
  const data = [
    {
      id: 1,
      logoUrl: 'http://via.placeholder.com/150x150',
      merchantName: 'OPPO',
      rating: 3.5,
      trending: 1,
      ...
      jobDetails: [
        {
          ...
          job_id: 1,
          name_store: 'CH1',
          address: 'Ly chinh thang',
          weekDay: [1, 3, 5],
          hourDay: [
            {start_time: '7:00', end_time: '9:00'},
        ...
        },
        {
          id: 3,
          job_id: 1,
          name_store: 'Sieu Thi Cho Lon',
          address: 'An Duong Vuong, Quan 5',
          weekDay: [1, 3, 5],
          hourDay: [
            {start_time: '7:00', end_time: '9:00'},
            {start_time: '10:00', end_time: '12:00'},
    ...
    },
    {
      ...
      rating: 4.5,
      trending: 2,
      jobTitle: 'PB/PG ra mắt thương hiệu Samsung',
      ageMin: 20,
      ageMax: 40,
      gender: 1,
